...
<body>
	...
	<script>
		$(function(){
			$(".breadcromb-box > h2").html("Tickets")
			$(".breadcromb-box ul li:last-child").html("Tickets")
		})
	</script>
</body>
</html>
