...
<body>
                ...
                <div class="col-md-8">
                    <div class="single-blog-page-section">
                        <div class="single-latest-post">
                            <img src="resources/img/post-1.jpg" alt="post image" />
                            <div class="single-post-text">
                                <h3>dipisicing elit sed do eiusmod</h3>
                                <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudi bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulp sit amet mauris.Aenean sollicitudi bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulp sit amet mauris,version of Lorem Ipsum.</p>
                        ...
                        <div class="single-blog-section-inner">
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley</p>
                            <ul>
                                <li>
                                    <i class="fa fa-hand-o-right"></i>
                                    Vivamus sit amet ipsum vitae sem condimentum porttitor quis 
                                </li>
                                <li>
                                    <i class="fa fa-hand-o-right"></i>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="admin-image">
                                        <img src="resources/img/admin.jpg" alt="admin" />
	...
	<script>
		$(function(){
			$(".breadcromb-box > h2").html("Single Blog")
			$(".breadcromb-box ul li:last-child").html("Single Blog")
		})
	</script>
</body>
</html>
