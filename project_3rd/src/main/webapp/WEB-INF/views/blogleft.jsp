...
<body>
    ...
    <section class="kick-blog-page-area section_100">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="single-fixture-page-right margin-bottom">
                ...
                <div class="col-md-8">
                    <div class="single-latest-post">
                        ...
                        <div class="single-post-text">
                            <h3><a href="#">dipisicing elit sed do eiusmod</a></h3>
                            <p class="post-date">11 Aug, 2017 / Jhon Doe</p>
                    ...
                    <div class="single-latest-post">
                        <a href="#"><img src="resources/img/post-3.jpg" alt="post image" /></a>
                        <div class="single-post-text">
                            <h3><a href="#">dipisicing elit sed do eiusmod</a></h3>
                            <p class="post-date">11 Aug, 2017 / Jhon Doe</p>
                            <p>Consectetur adipisicing elit sed do eiusmod temport incididunt utia labore et dolore magna aliqua enima ad minim veniam quistrud on ullamco laboris nisiut aliquip exea commodo consequat.</p>
	...
	<script>
		$(function(){
			$(".breadcromb-box > h2").html("Blog Left Sidebar")
			$(".breadcromb-box ul li:last-child").html("Blog Left Sidebar")
		})
	</script>
</body>
</html>
